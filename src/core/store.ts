...
const terminalOutboxEventSchema = z
  .object({
    ...
    receipt: z
      .object({
        status: z.enum(["accepted", "started", "produced", "provider_sent", "current_session_visible", "operator_visible", "timed_out", "stale", "failed", "sent", "provider_delivered_if_known"]),
        updatedAt: z.string(),
